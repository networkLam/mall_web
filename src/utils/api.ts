export default {
    ...
    UPDATEPRODUCTINFO:"/api/admin/product/update",//更新商品信息
    ADDPRODUCTINFO:"/api/product/add",//添加商品信息
    ORDERLIST:"/api/admin/order",//获取不同状态的订单数据
    ORDERCOUNT:"/api/order/count",//获取不同状态订单的数量（总数
    ORDERDETAIL:"/api/order/detail",//获取订单的详细信息
    ORDERUPDATE:"/api/admin/order/update",//订单更行
    PRODUCTINFO:"/api/product/info",//根据商品id获取商品的信息
    LOGINFO:"/api/admin/handle/msg",//查看商品的处理日志
    ...
    LOGORDER:"/api/admin/log/product",//订单日志 （这命名有问题
